# This is a default distribution 
# plug-in. Do not modify this file as 
# your changes will be overwritten on 
# next update. If you want customize 
# installation, please make a copy.
DISTRO_NAME="Kali"
